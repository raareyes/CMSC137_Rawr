...
//Constructors
	//For Client
	public Character(int player,String name, int x, int y,int playerType){
	...
	//For Server
	public Character(int player,String name,int playerType){
		...
		//this.setImage = null;//	new ImageIcon("Character/P2/upS1.png").getImage();
	}

	//setting the direction of the movement
	public void move(){

		if (this.getXPos() + Character.WIDTH + this.getDX() > 600){
			this.setDirection(0,this.getDY());
		}
		if (this.getYPos() + Character.HEIGHT + this.getDY() > 600){
	...
	public void randCoor(){
		...
		while(true){
			...
			Rectangle thisBounds = new Rectangle(randX,randY,Character.HEIGHT,Character.WIDTH);
			...
			for (Character object : Paint.players){
		...
		/*switch (this.direction){
			case 'w':
				if (this.animationState < 5)
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/upS1.png").getImage()):(new ImageIcon("Character/P2/upS1.png").getImage()));
            	else
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/upS2.png").getImage()):(new ImageIcon("Character/P2/upS2.png").getImage()));
			break;
			case 'a':
	            if (this.animationState < 5)
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/leftS1.png").getImage()):(new ImageIcon("Character/P2/leftS1.png").getImage()));
            	else
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/leftS2.png").getImage()):(new ImageIcon("Character/P2/leftS2.png").getImage()));

			break;
			case 's':
				if (this.animationState < 5)
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/downS1.png").getImage()):(new ImageIcon("Character/P2/downS1.png").getImage()));
            	else
            		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/downS2.png").getImage()):(new ImageIcon("Character/P2/downS2.png").getImage()));
			break;
			case 'd':
				 if (this.animationState < 5)
	            	//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/rightS1.png").getImage()):(new ImageIcon("Character/P2/rightS1.png").getImage()));
	           	else
	           		//this.setImage(this.player == CP1? (new ImageIcon("Character/P1/rightS2.png").getImage()):(new ImageIcon("Character/P2/rightS2.png").getImage()));
			break;
		}*/
	}
...
//Pseudo key listeners
	...
	public void attack(){
		for (Character player : Paint.getCharacters()){
